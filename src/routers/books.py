...
@books_bp.route("/add-folder", methods=["POST"])
def add_folder():
    try:
        data = request.json
...
@books_bp.route("/edit-folder/<folder_name>", methods=["POST"])
...
# Удалить книгу
@books_bp.route("/delete-folder/<path:folder_name>", methods=["DELETE"])
